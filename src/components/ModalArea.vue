        ...
        <div class="modal_content">
            <div class="modal_wrapper">
                ...
                <picture class="modal_img" ref="modal_img" v-bind:style="{transform: this.imgSize}">
                    <source :srcset="val.img_src_pc" media="(min-width: 1024px) and (orientation : landscape)"/><!-- 幅1024px以上なら表示 -->
                    <img :src="val.img_src" alt="">
                </picture>
                <div class="modal_detail">
                    <div class="modal_title"><span>{{ val.title }}</span></div>
                    <div class="role">
                        <h3>担当フェーズ</h3>
