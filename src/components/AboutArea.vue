            ...
            <div class="pc_flex">
                ...
                <div class="profile_detail scroll_ani">
                    ...
                    <p>
                        ...
                        このプロジェクトにて、Linux系のサーバーで使われる「シェルスクリプト」と<span>エクセル</span>で使われる「VBA」の<span>2つ</span>の<span>プログラミング</span>言語を<span>経験。</span></p>
                    <p>
                        ...
                        <span>2年間</span>バックエンドでの仕事を経験しているため、<span>プログラミング</span>の理解には自信があります。
                    </p>
                </div>
            </div>
        </div><!-- /about_flex -->
